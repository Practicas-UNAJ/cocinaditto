...
export const Delete: NextComponentType = () => {
    return (
        <div className="flex flex-col items-center max-w-xs text-center card-gradient rounded-2xl py-3 text-card-900 font-semibold">
            ...
            <div className="flex flex-row gap-2">
                ...
                <button className="rounded-full p-3 border-2 border-card-900">Cancelar</button>
            </div>
        </div>
    )
}