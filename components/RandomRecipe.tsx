    ...
    return (
        <div className="flex flex-row gap-3 self-center">
            ...
            <div className="flex flex-col gap-2 items-center">
                ...
                <button className="bg-gradient-radial from-secondary-500 to-secondary-600 text-white w-fit py-1 px-3 rounded-md shadow-[0px_4px_4px_rgba(0,0,0,0.25)]">Receta Aleatoria</button>
            </div>
        </div>
    )
}